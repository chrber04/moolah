 ...
 *
 * @example
 * const code: CountryCode = CountryCode.AFGHANISTAN;
 * // console.log(code) -> "AF"
 */
export const CountryCode = {
	...
	KIRIBATI: "KI",
	/**
	 * Non-standard code: Kosovo (unofficial ISO code)
	 * This is used by many organizations despite not being an official ISO 3166-1 code
	 */
	KOSOVO: "XK",
	KOREA: "KR",
	...
	NETHERLANDS: "NL",
	/**
	 * Deprecated code: Netherlands Antilles (dissolved in 2010)
	 * Included for historical data compatibility
	 * Replaced by CW (Curaçao), SX (Sint Maarten), and BQ (Bonaire, Sint Eustatius and Saba)
	 */
	...
	SERBIA: "RS",
	/**
	 * Deprecated code: Serbia and Montenegro (dissolved in 2006)
	 * Included for historical data compatibility
